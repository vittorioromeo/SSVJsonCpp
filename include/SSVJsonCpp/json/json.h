...
namespace Json
{
	...
	class ValueIteratorBase
	{
		...
		public:
			...
			inline bool operator==(const SelfType& other) const { return isEqual(other); }
			inline bool operator!=(const SelfType& other) const { return !isEqual(other); }
			inline difference_type operator-(const SelfType& other) const { return computeDistance(other); }
			Value key() const;
			UInt index() const;
	...
	class ValueConstIterator : public ValueIteratorBase
	{
		...
		public:
			...
			inline SelfType operator--(int)		{ SelfType temp(*this); --*this; return temp; }
			inline SelfType& operator--()		{ decrement(); return *this; }
